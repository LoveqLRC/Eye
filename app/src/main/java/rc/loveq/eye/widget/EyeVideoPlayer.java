...
public class EyeVideoPlayer extends StandardGSYVideoPlayer {
    ...
    public int getLayoutId() {
        return R.layout.eye_video_player;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        EyeVideoPlayer sampleVideo = (EyeVideoPlayer) super.startWindowFullscreen(context, actionBar, statusBar);
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            EyeVideoPlayer sampleVideo = (EyeVideoPlayer) gsyVideoPlayer;
